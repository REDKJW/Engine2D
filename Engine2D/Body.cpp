...
bool Body::Initialize(HINSTANCE hInstance, int nCmdShow, int w, int h, LPCWSTR title)
{
    ...
    scenemanager->sceneSwitcher(ENTRY_SCENE); //기본 진입점으로 초기화

    initializer(scenemanager, hDC, STANDARD_WIDTH, STANDARD_HEIGHT); //구성 원소 초기화.
...
void Body::messageLoop()
{
    ...
    //MessageBox(NULL, L"메시지 루프 탈출", NULL, MB_OK);
}
